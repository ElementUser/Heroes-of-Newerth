...
# https://docs.google.com/spreadsheets/d/1f98szyd025VFLrT1yBZG_9lQZiz0eIZ3sbBX49xNX4U/edit#gid=585347818
# =============================================================================================================
...
def line_starts_with_prefix(line: str, prefix_list: List[str]) -> bool:
    """
    Checks to see if the line string starts with any of the string entries in the given str_list

    Returns True if a match is found, False otherwise
    """
    return len(list(filter(line.startswith, prefix_list))) > 0
...
def formatPatchNotes_InGame(destFile: str) -> None:
    ...
    with in_place.InPlace(destFile) as file:
        for line in file:
            # Replace Microsoft apostrophes with the real single quote character
            line = line.replace("’", "'")
